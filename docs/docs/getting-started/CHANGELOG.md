...
· 次版本号：&nbsp;&nbsp;包含新特性的向下兼容的版本更新，发布时间不定。</font>
...
- **react-navigation:** 修复 react-navigation 在二级页面首页无法接受参数的问题 ([#34](https://github.com/tuya/tuya-panel-kit/issues/34)) ([f71ebda](https://github.com/tuya/tuya-panel-kit/commit/f71ebda9a2e5103cb69f263bb74e6810013acb5a))

### Features

- **Beacon:** 新增蓝牙 Beacon 协议 ([#35](https://github.com/tuya/tuya-panel-kit/issues/35)) ([5fedcfb](https://github.com/tuya/tuya-panel-kit/commit/5fedcfb854ab58d8db42575da41620cf8f9b2fcb))
...
- **ToastView:** ToastView 动画时间调整 ([1f49cf4](https://github.com/tuya/tuya-panel-kit/commit/1f49cf45d8bc6d42f7cb49bb7cb69dfcd1e6c72e))
...
- **TYList:** 修复未跟随主题的 bug ([ae3d7fd](https://github.com/tuya/tuya-panel-kit/commit/ae3d7fd9f2bdc13801238180a1a777e4afc4249a))
